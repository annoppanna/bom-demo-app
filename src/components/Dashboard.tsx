...
const Dashboard = () => {
  const kpis = [
    ...
    {
      title: "คำสั่งผลิตที่กำลังดำเนินการ",
      value: "156",
      unit: "รายการ",
      change: "+8.7%",
      trend: "up",
  ...
  const materialAlerts = [
    { material: "แป้งสาลีชนิดที่ 1", stock: 120, minimum: 200, status: "low" },
    { material: "ปลาแซลมอนสด", stock: 45, minimum: 50, status: "critical" },
    { material: "น้ำตาล", stock: 380, minimum: 100, status: "good" },
  ];
  ...
  return (
    <div className="space-y-6">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        คงเหลือ: {alert.stock} | ขั้นต่ำ: {alert.minimum}
                      </p>
                    </div>
                  </div>
                  <span
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="p-6 border-b border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900">
            เปรียบเทียบแผนการผลิตกับผลผลิตจริง (ย้อนหลัง 7 วัน)
          </h3>
        </div>
        <div className="p-6">
          <div className="h-64 flex items-end justify-between space-x-2">
            {[
              { day: "จ.", forecast: 280, actual: 265 },
              { day: "อ.", forecast: 320, actual: 342 },
              { day: "พ.", forecast: 290, actual: 278 },
              { day: "พฤ.", forecast: 350, actual: 367 },
              { day: "ศ.", forecast: 380, actual: 392 },
              { day: "ส.", forecast: 250, actual: 234 },
              { day: "อา.", forecast: 200, actual: 189 },
            ].map((data, index) => (
          ...
          <div className="flex items-center justify-center mt-4 space-x-6">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-gray-600">แผนการผลิต</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-3 h-3 bg-[#8F262B] rounded"></div>
              <span className="text-sm text-gray-600">ผลผลิตจริง</span>
            </div>
          </div>
        </div>
      </div>
