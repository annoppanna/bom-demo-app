...
const Sidebar: React.FC<SidebarProps> = ({ activeModule, setActiveModule }) => {
  const menuItems = [
    ...
    { id: "raw-materials", name: "วัตถุดิบ", icon: Package },
    { id: "production-orders", name: "คำสั่งผลิต", icon: ClipboardList },
    { id: "planning", name: "วางแผนการผลิต", icon: Calendar },
    { id: "rnd", name: "วิจัยและพัฒนา (R&D)", icon: FlaskConical },
      ...
      <nav className="mt-8">
        {menuItems.map((item) => {
          ...
          return (
            ...
            >
              <Icon
                className={`w-5 h-5 mr-3 ${isActive ? "text-[#8F262B]" : "text-gray-500"}`}
              />
